...
def search_json_file(endpoint, cs_excluded, file):
    ...
    fhirpath_expressions = [
        ...
        "contained.form.coding",
        "connectionType.coding",
        "contentType.coding",
        "dosage.route.coding",
        "dosageInstruction.route.coding",
        "dosageInstruction.doseAndRate.doseQuantity.code",
        "doseAndRate.doseQuantity.code",
        "doseQuantity.coding",
        "extension.type.coding",
        "extension.valueCoding.code",
        "extension.extension.valueCodableConcept.coding",
        "extension.valueCodableConcept.coding",
        "focalDevice.action.coding",
        "form.coding",
        "format.coding",
        "groupIdentifier.type.coding",
        "identifier.extension.valueCoding",
        ...
        "outcome.coding",
        "participant.individual.identifer.type.coding",
        ...
        "provision.class",
        "qualification.extension.extension.valueCodeableConcept",
        "qualification.identifier.code.coding",
        "qualification.identifier.type.coding",
        "reaction.manifestation.coding"
        "reaction.substance.coding",
        "reasonCode.coding",
        "relationship.coding",
        "requisition.type.coding",
        "route.coding",
        "scope.coding",
        "serviceType.coding",
        "severity.coding",
